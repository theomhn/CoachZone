 ...
 */
final class Version20250306152526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE institution (id INT NOT NULL, inst_numero VARCHAR(255) NOT NULL, inst_name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_3A9F98E5FF01948B (inst_numero), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE place (id VARCHAR(255) NOT NULL, inst_numero VARCHAR(255) NOT NULL, inst_name VARCHAR(255) NOT NULL, data JSON NOT NULL, last_update DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
